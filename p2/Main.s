...
_P_Main_ForkMonitor:
	...
	jmp	_Method_P_Main_ForkMonitor_7	! 20:	getLeftPhilosopher
	jmp	_Method_P_Main_ForkMonitor_6	! 24:	getRightPhilosopher
	jmp	_Method_P_Main_ForkMonitor_5	! 28:	areNeighborsNotEating
	jmp	_Method_P_Main_ForkMonitor_4	! 32:	testAndSetEating
	.word	0
! 
! Class descriptor:
! 
...
!   _temp_617 = 4		(4 bytes)
	...
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: index = _temp_616  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-196]
_Label_612:
!   Perform the FOR-LOOP termination test
!   if index > _temp_617 then goto _Label_615		
	load	[r14+-196],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_618 = &conditions
	...
	add	r1,24,r1
	store	r1,[r14+-16]
!   Move address of _temp_618 [index ] into _temp_619
!     make sure index expr is >= 0
	load	[r14+-196],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_649 = *_temp_651  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-36]
!   if _temp_649 == 2 then goto _Label_648		(int)
	load	[r14+-36],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_648
...
!   Prepare Argument: offset=12  value=p  sizeInBytes=4
	load	[r14+12],r1
	store	r1,[r15+4]
!   Send message getRightPhilosopher
	load	[r14+-32],r1
	load	[r1],r2
	cmp	r2,0
	be	 _runtimeErrorUninitializedObject
...
!   Prepare Argument: offset=12  value=p  sizeInBytes=4
	load	[r14+12],r1
	store	r1,[r15+4]
!   Send message getLeftPhilosopher
	load	[r14+-20],r1
	load	[r1],r2
	cmp	r2,0
	be	 _runtimeErrorUninitializedObject
	...
	add	r2,20,r2
	call	r2
!   Retrieve Result: targetName=_temp_678  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-24]
	load	[r14+8],r1
	store	r1,[r14+-16]
...
!   Prepare Argument: offset=12  value=p  sizeInBytes=4
	load	[r14+12],r1
	store	r1,[r15+4]
!   Send message areNeighborsNotEating
	load	[r14+-48],r1
	load	[r1],r2
	cmp	r2,0
	be	 _runtimeErrorUninitializedObject
	...
	add	r2,28,r2
	call	r2
!   if result==true then goto _Label_698 else goto _Label_697
	loadb	[r15],r1
	cmp	r1,0
	be	_Label_697
	jmp	_Label_698
...
!   _temp_703 = &status
	...
	add	r1,108,r1
	store	r1,[r14+-32]
!   Move address of _temp_703 [p ] into _temp_704
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_706 = &mutexLock
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   _temp_707 = &conditions
	load	[r14+8],r1
	add	r1,24,r1
	store	r1,[r14+-16]
!   Move address of _temp_707 [p ] into _temp_708
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Send message getRightPhilosopher
	...
	add	r2,24,r2
	call	r2
!   Retrieve Result: targetName=_temp_729  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-44]
...
!   Data Move: _temp_727 = *_temp_731  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-52]
!   if _temp_727 == 2 then goto _Label_724		(int)
	load	[r14+-52],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_724
...
!   Send message getLeftPhilosopher
	...
	add	r2,20,r2
	call	r2
!   Retrieve Result: targetName=_temp_734  sizeInBytes=4
	load	[r15],r1
	store	r1,[r14+-24]
...
!   Data Move: _temp_732 = *_temp_736  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-32]
!   if _temp_732 == 2 then goto _Label_724		(int)
	load	[r14+-32],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_724
...
!   _temp_722 = 0		(1 byte)
	...
	storeb	r1,[r14+-9]
_Label_725:
!   ReturnResult: _temp_722  (sizeInBytes=1)
	loadb	[r14+-9],r1
	storeb	r1,[r14+8]
	add	r15,56,r15
	pop	r13
...
!   _temp_758 = _temp_759 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-16]
!   ReturnResult: _temp_758  (sizeInBytes=4)
	load	[r14+-16],r1
	store	r1,[r14+8]
	add	r15,12,r15
	pop	r13
